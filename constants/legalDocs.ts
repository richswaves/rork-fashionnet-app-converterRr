...
If you have questions about these Terms, contact us at tbrxnd@gmail.com.` as const;
...
Your Rights: You can access and update your profile information in the app. You can also request that we delete your account and personal data by contacting us at tbrxnd@gmail.com Upon verification, we will delete your data. If you live in California or other jurisdictions with special privacy laws, you may have additional rights (e.g. to access, correct, or delete your data); please contact tbrxnd@gmail.com for assistance. We will honor all lawful requests.
...
We aim for transparency and consistency. Thank you for helping us keep the community respectful.` as const;

export const DMCA_POLICY = `DMCA Takedown Policy
...
By using thebrxnd, you agree to this DPA along with our Privacy Policy. If you have questions about data processing, contact us at tbrxnd@gmail.com.` as const;
