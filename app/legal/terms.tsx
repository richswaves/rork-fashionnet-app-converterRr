...
Account and Subscription: Some features require a paid subscription. You authorize us to charge a monthly fee of $9.99 (USD) for the subscription. A free 7-day trial is offered for new users. After the trial, the subscription automatically renews each month until you cancel. To avoid charges after the free trial, cancel at least 24 hours before the trial ends. You can cancel anytime through your device’s App Store/Google Play subscription settings. We do not collect or store your payment information; payments are processed by Apple or Google on our behalf. Subscription fees are non-refundable except as required by law. No discretionary refunds will be given beyond the refund policies of the App Store or Google Play.
...
Termination: We may suspend or terminate your access if you breach these Terms, applicable law, or behave in a harmful way. If we terminate your account, your content will be removed and you will lose access to the app. Subscriptions will be canceled in accordance with store policies, but fees already paid are non-refundable (except as required by law). If you believe your account was terminated unfairly, use the appeal process above.
